...
initSpeakingInjections() async {
  final speakingP1Box = await Hive.openBox('speaking_p1_box');
  final speakingP2Box = await Hive.openBox('speaking_p2_box');
  final speakingP3Box = await Hive.openBox('speaking_p3_box');
  final speakingP4Box = await Hive.openBox('speaking_p4_box');
  sl.registerLazySingleton<Box>(
    () => speakingP1Box,
    instanceName: 'speaking_p1_box',
  );
  sl.registerLazySingleton<Box>(
    () => speakingP2Box,
    instanceName: 'speaking_p2_box',
  );
  sl.registerLazySingleton<Box>(
    () => speakingP3Box,
    instanceName: 'speaking_p3_box',
  );
  sl.registerLazySingleton<Box>(
    () => speakingP4Box,
    instanceName: 'speaking_p4_box',
  );
  ...
  sl.registerLazySingleton<SpeakingP1Repository>(
    () =>
        SpeakingP1RepositoryImpl(remoteDataSource: sl(), localDataSource: sl()),
  );
  // DataSource
  sl.registerLazySingleton<SpeakingP1RemoteDataSource>(
    () => SpeakingP1RemoteDataSourceImpl(firestore: sl()),
  );
  sl.registerLazySingleton<SpeakingP1LocalDataSource>(
    () => SpeakingP1LocalDataSourceImpl(sl(instanceName: 'speaking_p1_box')),
  );
  ...
  sl.registerLazySingleton<SpeakingP2Repository>(
    () =>
        SpeakingP2RepositoryImpl(remoteDataSource: sl(), localDataSource: sl()),
  );
  // DataSource
  sl.registerLazySingleton<SpeakingP2RemoteDataSource>(
    () => SpeakingP2RemoteDataSourceImpl(firestore: sl()),
  );
  sl.registerLazySingleton<SpeakingP2LocalDataSource>(
    () => SpeakingP2LocalDataSourceImpl(sl(instanceName: 'speaking_p2_box')),
  );
  ...
  sl.registerLazySingleton<SpeakingP3Repository>(
    () =>
        SpeakingP3RepositoryImpl(remoteDataSource: sl(), localDataSource: sl()),
  );
  // DataSource
  sl.registerLazySingleton<SpeakingP3RemoteDataSource>(
    () => SpeakingP3RemoteDataSourceImpl(firestore: sl()),
  );
  sl.registerLazySingleton<SpeakingP3LocalDataSource>(
    () => SpeakingP3LocalDataSourceImpl(sl(instanceName: 'speaking_p3_box')),
  );
  ...
  sl.registerLazySingleton<SpeakingP4Repository>(
    () =>
        SpeakingP4RepositoryImpl(remoteDataSource: sl(), localDataSource: sl()),
  );
  // DataSource
  sl.registerLazySingleton<SpeakingP4RemoteDataSource>(
    () => SpeakingP4RemoteDataSourceImpl(firestore: sl()),
  );
  sl.registerLazySingleton<SpeakingP4LocalDataSource>(
    () => SpeakingP4LocalDataSourceImpl(sl(instanceName: 'speaking_p4_box')),
  );
}
